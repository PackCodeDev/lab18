...
int main() {
    ...
    while (getline(student_file, textline)) {
        ...
        // ใช้ sscanf() แยกค่าใน textline และเก็บใน struct s
        char name[100];
    ...
    while (getline(course_file, textline)) {
        if (state == 1) {
            ...
            if (textline == "> Students") {
                ...
                // เพิ่มชื่อผู้สอนเข้าไปใน lecture_list ของวิชาล่าสุด
            ...
            if (textline == "---------------------------------------") {
                ...
                // เพิ่ม pointer ของนักศึกษาเข้าไปใน student_list ของวิชาล่าสุด
                if (p != nullptr) {
